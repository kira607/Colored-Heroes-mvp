...
public class DeprecatedGame : MonoBehaviour
{
    ...
    private void InitializeBatlerManager()
    {
        ...
        _batler = batlerManager.GetComponent<Batler.Batler>();
        _batler.Init(batler, heroes, playerCastle, enemyCastle);
        _batler.LoadHeroes(_playerHeroesMetaNames, _enemyHeroesMetaNames);
    }
