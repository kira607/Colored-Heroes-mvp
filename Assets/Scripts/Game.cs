...
public class Game : MonoBehaviour
{
    ...
    public GameObject batlerManagerPrefab;

    [Header("Batler Manager Fields")] 
    ...
    private BatlerManager _batlerManager;
    ...
    private void InitializeBatlerManager()
    {
        GameObject batlerManager = Instantiate(batlerManagerPrefab);
        _batlerManager = batlerManager.GetComponent<BatlerManager>();
        _batlerManager.Init(batler, heroes, playerCastle, enemyCastle);
        _batlerManager.LoadHeroes(_playerHeroesMetaNames, _enemyHeroesMetaNames);
    }

    private void InitializeBot()
    {
        _bot = gameObject.transform.Find("Bot").GetComponent<Bot>();
        _batlerManager.SetBot(_bot);
    }
    ...
    private void InitializeFields()
    {
        ...
        _superSprites = new Dictionary<SuperColor, Sprite>
        {
            ...
            {SuperColor.Dimond, superChipsSprites[3]}
        };
    }
    ...
    {
        var scores = _scoreCounter.CountScore(ref _deadChips);
        _batlerManager.ApplyScore(scores);
    }
}